...
let isTinyUSB = function (d) {
  return d.vendorId === 0x239a && d.productId === 0x801e;
};

let device; // to be filled out below
//var deviceInfo
...
let numsentA = device.write(messageA);
...
let numsentB = device.write(messageB);
